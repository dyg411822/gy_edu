...
public class JodaTimeUtils {
    ...
    public static final FastDateFormat sdf_hh_mm_ss = FastDateFormat.getInstance(DF_TIME);
    ...
    //按格式化 获取日期
    public static String getStrCurrentDate(String date_format) {
        return convertDate2String(date_format, getCurrentDate());
    }
    ...
    /**
     * 时间范围搜索 结束时间格式化 yyyy-mm-dd 转为 yyyy-mm-dd 23:59:59
     */
...
//    public static void main(String[] args) {
        ...
        //  System.out.println(getBeforeLastMonthdate());
        // System.out.print(getYear());

//        Integer start = Integer.parseInt(DateUtils.dayForWeeks("2016-08-14"));
//        //Integer end = Integer.parseInt(DateUtils.dayForWeeks("2016-08-20"));
//
//        int diffDays = DateTimeUtils.diffDays(DateUtils.strToDate("2016-08-22"),DateUtils.strToDate("2016-08-12"));
//        System.out.println(start +"----"+diffDays);
//        List<Integer> list = new ArrayList<>();
//        long starts = DateUtils.strToDate("2016-08-12").getTime();
//        long ends = DateUtils.strToDate("2016-08-22").getTime();
//        for (int i =0 ;i<=diffDays;i++){
//                if (starts == ends){
//                    String temp = DateUtils.transferLongToDateString(starts);
//                    list.add(Integer.parseInt(DateUtils.dayForWeeks(temp)));
//                    break;
//                }else if (ends > starts){
...
//        }
        ...
        // System.out.println(getBeforeFirstMonthdateYYMMDD());
...
//        System.out.println(sdf.format(DateTimeUtils.getNowMonthEnd()));
      /*  Calendar calendar = Calendar.getInstance();
        Date now = new Date();
        System.out.println(DateTimeUtils.convertDate2String("yyyy-MM-dd HH:mm:ss",now));
        calendar.setTime(now);
        calendar.add(Calendar.MINUTE,60);
        System.out.println(DateTimeUtils.convertDate2String("yyyy-MM-dd HH:mm:ss",calendar.getTime()));

        System.out.println("---------------------------------------------");*/

        /*System.out.print( gethhmmss());

        SimpleDateFormat sdf=new SimpleDateFormat("HH:mm:ss");
        convertString2Date("HH:mm:ss",gethhmmss());*/
        // System.out.print(strToDate("2016-06-08"));
//    }
